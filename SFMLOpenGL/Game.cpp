...
void Game::initialize()
{
	...
	vertexA[0].coordinate[0] = -0.5f;
	vertexA[0].coordinate[1] = -0.5f;
	vertexA[0].coordinate[2] = 0.0f;

	vertexA[1].coordinate[0] = 0.5f;
	vertexA[1].coordinate[1] = -0.5f;
	vertexA[1].coordinate[2] = 0.0f;

	vertexA[2].coordinate[0] = 0.5f;
	vertexA[2].coordinate[1] = 0.5f;
	vertexA[2].coordinate[2] = 0.0f;

	vertexA[0].color[0] = 0.0f;
	vertexA[0].color[1] = 0.0f;
	vertexA[0].color[2] = 0.0f;
	vertexA[0].color[3] = 1.0f;

	vertexA[1].color[0] = 0.0f;
	vertexA[1].color[1] = 0.0f;
	vertexA[1].color[2] = 0.0f;
	vertexA[1].color[3] = 1.0f;

	vertexA[2].color[0] = 0.0f;
	vertexA[2].color[1] = 0.0f;
	vertexA[2].color[2] = 0.0f;
	vertexA[2].color[3] = 1.0f;
...
void Game::render()
{
	...
	//array2
	glBufferData(GL_ARRAY_BUFFER, sizeof(Vertex) * 3, vertexA, GL_STATIC_DRAW);
